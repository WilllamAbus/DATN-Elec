...
const cartItemSchema = new Schema({
    ...
    quantity: { type: Number, required: true, default: 1 }, // Số lượng sản phẩm trong giỏ
...
const cartSchema = Schema(
  {
    ...
    totalPrice: { type: Number, required: true, default: 0 }, // Tổng giá trị của toàn bộ giỏ hàng
