...
const inventorySchema = Schema(
  {
    ...
    newPrice: { type: Number, required: true }, // New purchase price per unit of the product
    inventoryPrice: { type: Number, required: true }, // Value of the inventory (quantity * new purchase price)
    quantityInventory: { type: Number, required: true }, // Quantity of product in the inventory
    totalValue: { type: Number, required: true }, // Total value of the product in inventory (quantityInventory * newPrice)
