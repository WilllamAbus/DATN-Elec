...
const productService = {
    ...
    edditProductV2: async(id, updatedData, newImages)=>{
        try {
            ...
            product.product_condition = updatedData.product_condition || product.product_condition;
            product.product_format = updatedData.product_format || product.product_format;
    ...
    getProductById: async (id) => {
      ...
      searchProducts :async (keyword) => {
        try {
            ...
            const products = await Product_v2.find({ product_name: { $regex: keyword, $options: 'i' } })
