...
const _Inventory = require('../model/inventory/inventory.model')
...
const inventoryService = {
    ...
    //   },
    // getAllInventory: async (res) => {
    //     try {
    //         const inventory = await _Inventory.find({ status: { $ne: 'disable' } })
    ...
    //                 throw new Error('Failed to populate product or supplier.');
    //             }
    //         });
