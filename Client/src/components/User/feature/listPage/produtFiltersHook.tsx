...
import { FilterState,ProductBrand,ProductCondition,QueryParamAuction,RAM } from "../../../../services/clientcate/client/types/getProuctbyCategory";
import { getBrandNameById, getConditionNameById,getRamNameById } from "./Utils"; 

const useProductFilters = (initialQueryParams: QueryParamAuction, brands: ProductBrand[], conditions: ProductCondition[], rams: RAM[]) => {
  ...
  const [filters, setFilters] = useState<FilterState>({
    ...
    rams: queryParams.ram ? (queryParams.ram as string).split(',').map(_id => ({
      _id,
      name: getRamNameById(rams, _id)
    })) : [],  
