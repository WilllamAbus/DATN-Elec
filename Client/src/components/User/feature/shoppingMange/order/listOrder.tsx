...
const OrderList: React.FC = () => {
  ...
  const [selectedOrder, setSelectedOrder] = useState<Order | null>(null); // Trạng thái để lưu đơn hàng được chọn
  ...
  return (
    <div className="mt-7 border border-gray-300 pt-9">
      {/* Kiểm tra nếu đã chọn đơn hàng để hiển thị chi tiết */}
      {selectedOrder ? (
                      ...
                      <div className="w-full">
                        <div className="relative h-auto">
                          {order.cartDetails
                            ...
                            .map((item, index) => (
                              <div
                                key={item.product._id} // Thay đổi từ index thành item.product._id để tránh trùng lặp key
