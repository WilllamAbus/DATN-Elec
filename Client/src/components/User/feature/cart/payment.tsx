...
// import { Order, ShippingAddress } from "../../../../types/order/order";
...
//       toast.error("Thông tin người dùng hoặc địa chỉ giao hàng không hợp lệ.");
//       return;
//     }
...
//           _id: item._id, // Sử dụng _id của giỏ hàng thay vì của item
//         }))
//       ),
//       payment: {
//         amount: grandTotal,
...
const CheckoutPage: React.FC = () => {
  ...
  const handleCheckout: SubmitHandler<FormData> = async (data) => {
    ...
    const orderData: Order = {
      ...
      shippingAddressId: shippingAddress,
      // voucher: voucherCode ? [voucherCode] : [], // Thêm mã voucher nếu có
      voucher: [],
      formatShipping: "Nhanh",
      totalAmount: grandTotal,
