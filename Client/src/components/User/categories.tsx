...
const Categories: React.FC = () => {
    return (
        <div className="container py-16">
            <h2 className="text-2xl font-medium text-gray-800 uppercase mb-6">Mua sắm theo danh mục</h2>
            <div className="grid grid-cols-3 gap-3">
                <Link to="#" className="relative rounded-sm overflow-hidden group">
                    <img src={cateOne} alt="category 1" className="w-50" />
                    {/* <a href="#"
                ...
                <Link to="#" className="relative rounded-sm overflow-hidden group">
                    <img src={cateTwo} alt="category 2" className="w-80" />
                    {/* <a href="#"
                ...
                <div className="relative rounded-sm overflow-hidden group">
                    <img src={cateThree} alt="category 3" className="w-80" />
                    {/* <a href="#"
                ...
                <div className="relative rounded-sm overflow-hidden group">
                    <img src={cateFour} alt="category 4" className="w-80" />
                    {/* <a href="#"
                ...
                <div className="relative rounded-sm overflow-hidden group">
                    <img src={cateFive} alt="category 5" className="w-80" />
                    {/* <a href="#"
                ...
                <div className="relative rounded-sm overflow-hidden group">
                    <img src={cateSix} alt="category 6" className="w-80" />
                    {/* <a href="#"
