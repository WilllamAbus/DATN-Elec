...
import DropdownLogoAdminNav from "../../ultils/dropdown/admin/nav/toggleDropdown";
const NavAdmin: React.FC = () => {
  return (
    <nav className="fixed z-30 w-full bg-primary-900 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
