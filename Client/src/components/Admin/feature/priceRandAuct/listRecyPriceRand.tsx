...
import { fetchPriceRandDeleted , restorePriceRandAdminThunk, }
...
import {PriceRangeRestoreAuct,} from '../../../../types/adminPriceRandAuct/deletePriceRandAuct'
...
//   const [, setPriceRandAuct] = useState<PriceRangeDelAuct[]>([]);
  useEffect(() => {
    ...
    <>
      ...
      <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        ...
        <th scope="col" className="p-4">STT</th>
          ...
          <th scope="col" className="p-4">Giá khởi điểm (đ)</th>
          <th scope="col" className="p-4">Giá tối đa (đ)</th>
          <th scope="col" className="p-4">Bước giá (đ)</th>
          <th scope="col" className="p-4">Thời gian bắt đầu  </th>
          <th scope="col" className="p-4">Thời gian kết thúc  </th>
