...
const Footer: React.FC = () => {
  return (
    <>
      <footer className=" flex-col min-h-screenp-4 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
