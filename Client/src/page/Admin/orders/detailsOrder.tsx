          ...
          <main className="w-full flex-grow p-6">
                ...
                <div className="w-full mt-12">
                    <p className="text-xl pb-3 flex items-center">
                        <i className="fas fa-list mr-3"></i> DANH SÁCH HÓA DƠN CHI TIẾT
                    </p>
                        ...
                        <table className="text-left w-full border-collapse"> 
                            ...
                            <tr className="hover:bg-grey-lighter">
                                        ...
                                        <td>
                                          ...
                                          >Xoá</a>
                                            {/* <a  href="/admin/categories/editCate/<%=cate.idCate%>"className="delete-link cta-btn btn text-decoration:none;color:green;" >Sửa</a> */}
                                        </td>
                                    </tr>
