...
import AdminFetListSuppliers from "../../../components/Admin/feature/inbound/list";
              ...
              <div className="w-full md:w-1/2">
                <form className="flex items-center">
                  ...
                  <div className="relative w-full">
                    <button  type="button" className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                      <svg
                        aria-hidden="true"
