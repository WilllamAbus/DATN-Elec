        ...
        <div className="relative w-full flex flex-col h-screen overflow-y-hidden">
          ...
          <main className="w-full flex-grow p-6">
                        ...
                        <table className="text-left w-full border-collapse"> 
                            ...
                            <tr className="hover:bg-grey-lighter">
                                        ...
                                        <td className="py-4 px-6 border-b border-grey-light">
                                            <img src="/images/uploads/<%= cate.imgCate %>" className="width: 50px; height: 50px;"/></td>
                                       
                                      
                                        <td>
                                            <a href="/admin/categories/listCate/<%=cate.idCate%>" 
                                            className="delete-link cta-btn btn text-decoration:none;color:green;"  
                                          >Xoá</a>
                                            <a  href="/admin/categories/editCate/<%=cate.idCate%>"
                                            className="delete-link cta-btn btn text-decoration:none;color:green;" >Sửa</a>
                                        </td>
                                    </tr>
                ...
                <div className="mt-6 ">
                    ...
                    <button className=" px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit"><a href="/">Trở lại</a></button>
                </div>
            </main>
