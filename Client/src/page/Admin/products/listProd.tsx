        ...
        <div className="relative w-full flex flex-col h-screen overflow-y-hidden">
          ...
          <main className="w-full flex-grow p-6">
                        ...
                        <table className="text-left w-full border-collapse"> 
                            ...
                            <tr className="hover:bg-grey-lighter">
                                        ...
                                        <td>
                                          ...
                                          >Xoá</a>
                                            <a  href="/admin/editProducts"className="delete-link p-4 cta-btn btn text-decoration:none;color:green;" >Sửa</a>
                                        </td>
                                    </tr>
                ...
                <div className="mt-6 flex gap-2">
                    <button className=" px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit"><a href="/admin/addProducts">Thêm mới</a></button>
