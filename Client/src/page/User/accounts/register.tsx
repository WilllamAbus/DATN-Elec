        ...
        <form id="addLoginButton" action="" method="post" autoComplete="off">
            <div className="space-y-2">
                <div>
                    ...
                    <span id="nameRegisError" className="error"></span>
                ...
                <div>
                    <label htmlFor="confirm_password" className="text-gray-600 mb-2 block">Xác nhận mật khẩu</label>
                    <span id="confirmPasswordRegisError" className="error"></span>
