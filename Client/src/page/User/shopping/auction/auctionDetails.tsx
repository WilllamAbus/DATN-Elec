    ...
    return (
        <>
            ...
            <div className="container grid grid-cols-2 gap-6">
                <div>
                    <img src='/images/uploads/' alt="product" className="w-full" />
                ...
                <div>
                    ...
                    <div className="mt-6 flex gap-3 border-b border-gray-200 pb-5 pt-5">
                        <a href="/site/trade/cart" className="bg-primary border border-primary text-white px-8 py-2 font-medium rounded uppercase flex items-center gap-2 hover:bg-transparent hover:text-primary transition">
                            <i className="fa-solid fa-bag-shopping"></i> Đấu giá
                        </a>
            ...
            <div className="container py-8">
                ...
                <div className="flex items-start space-x-4 mb-4">
                            <div className="flex-shrink-0">
                                <img className="h-10 w-10 rounded-full" src="/images/avatar.jpg" alt="avatar" />
                            </div>
            ...
            <div className="container pb-16">
                ...
                <div className="grid grid-cols-4 gap-6">
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                        <img src="/images/products/product1.jpg" alt="related-product" className="w-full" />
                        <div className="p-4">
